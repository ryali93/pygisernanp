...
# PATH_GDB = r'E:\sernanp\data\DB_TELEDETECCION_new.gdb'
# gpo_deforestacion_acum = os.path.join(PATH_GDB, r"fd_monitoreo\MonitDeforAcum")
# gpo_anp = os.path.join(PATH_GDB, 'gpo_anp')
# path_salida = r'E:\sernanp\data'
...
class M01_descargaATD_Geobosques(object):
    ...
    def download_atd(self, path):
        url_download = u"http://geobosques.minam.gob.pe/geobosque/descargas_geobosque/alerta/espaciales/Alertas_PNCB_raster_2021.zip"
